...
{/*
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:underline">At home</a></li>
              <li><a href="#" className="hover:underline">At school</a></li>
              <li><a href="#" className="hover:underline">At work</a></li>
...
*/     }   
        ...
        <div className="mt-10 border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-gray-400 text-sm">
            <p>Copyright &copy; {new Date().getFullYear()}, GlobQuiz! All Rights Reserved.</p>
          </div>
        </div>
      </div>
    </footer>
